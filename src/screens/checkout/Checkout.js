...
class Checkout extends Component {
    ...
    componentDidMount() {
        if (sessionStorage.getItem('access-token') !== null && this.props.location.state !== undefined) {
            this.fetchAddress();
            this.fetchStates();
            this.fetchPayments();
        }
    ...
    render() {
        ...
        return <Fragment>
            <Header baseUrl={this.props.baseUrl} history={this.props.history} ></Header>
                    ...
                    <Card variant='elevation' className='summary-card'>
                        <CardContent>
                            ...
                            <Typography variant='h6' component='h3' color='textSecondary'
                                ...
                                {this.props.location.state !== undefined ? this.props.location.state.restaurantName : ""}
                            </Typography>
                            {this.props.location.state !== undefined ?
                                <CheckoutItems divider='true' orderitems={this.props.location.state.orderItems}
                                    total={this.props.location.state !== undefined ? this.props.location.state.total : 0} placeOrder={this.placeOrder} />
                                : null
                            }
                        </CardContent>
                    </Card>
            ...
            <div>
                <SnackBarNotification open={this.state.placeOrderMessageOpen} notificationCloseHandler={this.placeOrderMessageClose}
